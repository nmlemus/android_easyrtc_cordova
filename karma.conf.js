...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'app/lib/ng-mfb/src/mfb-directive.js',
            'app/lib/angular-material-icons/angular-material-icons.min.js',
            'app/lib/intl-tel-input/build/js/intlTelInput.min.js',
            'app/lib/intl-tel-input/lib/libphonenumber/build/utils.js',
            'app/lib/international-phone-number/releases/international-phone-number.js',
            <!-- endinjector -->
